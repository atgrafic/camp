...
export default class extends view {
    ...
    async getHtml() {
        ...
        <div class="breadcrumb_menu">
            ...
            <li> <a class="position_page" href=/Kolonie/Kolonie-i-obozy-tematyczne/Kolonia-15-przygod" data-link>Kolonie 15 Przygód</a></li>
            </ul>
        </div>
    </div>
    ...
    <li><a class="li-active href="/Kolonie/Kolonie-i-obozy-tematyczne/Kolonia-15-przygod" data-link>Kolonie 15 Przygód</a></li>
...
function chooseCampSubject15() {
    // let capmpAll = document.querySelector(".camp_all");
    let listCamp = "";

    for (let i = 0; i <camp.length; i++) {
      if(camp[i].name === "Kolonia 15 przygód"){
