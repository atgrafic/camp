...
export default class extends view {
    ...
    async getHtml() {
        ...
        <div class="breadcrumb_menu">
            ...
            <li> <a class="position_page" href="/Kolonie/Kolonie-i-obozy-tematyczne/Akademia-malarstwa" data-link>Akademia Malarstwa</a></li>
            </ul>
        </div>
    </div>
    ...
    <li><a class="li-active href="/Kolonie/Kolonie-i-obozy-tematyczne/Akademia-malarstwa" data-link>Akademia Malarstwa</a></li>
...
function chooseCampSubjectPaint() {
    // let capmpAll = document.querySelector(".camp_all");
    let listCamp = "";

    for (let i = 0; i <camp.length; i++) {
      if(camp[i].name === "Akademia Malarstwa"){
