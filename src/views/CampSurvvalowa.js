...
export default class extends view {
    ...
    async getHtml() {
        ...
        <div class="breadcrumb_menu">
            ...
            <li> <a class="position_page" href=/Kolonie/Kolonie-i-obozy-tematyczne/Kolonia-survalowa"data-link>kolonia Survivalowa</a></li>
            </ul>
        </div>
    </div>
    ...
    <li><a class="li-active href="/Kolonie/Kolonie-i-obozy-tematyczne/Kolonia-survalowa"data-link>kolonia Survivalowa</a></li>
...
function chooseCampSubjectPaint() {
    ...
    for (let i = 0; i <camp.length; i++) {
      if(camp[i].name === "Kolonia surwiwalu"){
