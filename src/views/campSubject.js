...
function breadcrumb() {
    let breadcrumbSubject = "";
    for (let i = 0; i < campSubject.length; i++) {
        breadcrumbSubject += `
        ...
        <div class="breadcrumb_menu">
            <ul class="breadcrumb">
                 ...
                 <li> <a class="position_page" href="/${campSubject[i].name}" data-link>Obozy zagraniczne</a></li>
            </ul>
        </div>
    </div>
          `;
    }
    return breadcrumbSubject;
}
...
function listSubject() {
    ...
    for (let i = 0; i < campSubject.length; i++) {
        ...
        <ul class="list_sub_ul">
            <li>
                <a href="//${campSubject[i].name}" data-link>
                ${campSubject[i].name}
                </a>
            </li>
        </ul>`
