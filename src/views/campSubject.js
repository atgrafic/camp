...
export default class extends view {
    ...
    async getHtml() {
        ...
        <div class="breadcrumb_menu">
            ...
            <li> <a class="position_page" href="/Kolonie/Kolonie-i-obozy-tematyczne/Akademia-relaksu" data-link>Akademia Relaksu</a></li>
            </ul>
        </div>
    </div>
    ...
    <li class="li-active"><a class="li-active" href="/Kolonie/Kolonie-i-obozy-tematyczne/Akademia-relaksu" data-link>Akademia Relaksu</a></li>
...
function chooseCampSubject() {
    // let capmpAll = document.querySelector(".camp_all");
    let listCamp = "";

    for (let i = 0; i <camp.length; i++) {
      if(camp[i].name === "Akademia Relaksu"){
