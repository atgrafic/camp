...
export default class extends view {
    ...
    async getHtml() {
        ...
        <div class="breadcrumb_menu">
            ...
            <li> <a class="position_page" href="/Kolonie/Kolonie-i-obozy-tematyczne/Akademia-wokalu" data-link>Akademia Wokalu</a></li>
            </ul>
        </div>
    </div>
    ...
    <li><a class="li-active href="/Kolonie/Kolonie-i-obozy-tematyczne/Akademia-wokalu" data-link>Akademia Wokalu</a></li>
...
function chooseCampSubjectPaint() {
    ...
    for (let i = 0; i <camp.length; i++) {
      if(camp[i].name === "Akademia Wokalu"){
