    ...
    for (let i = 0; i < camp.length; i++) {
        if (campId === camp[i].id) {
            return `<div class="main-box">
                <div class="sumPhoto">
                    <img id="carPhoto1" src="${camp[i].image[0]}">
                    <img id="carPhoto2" src="${camp[i].image[1]}">
                    <img id="carPhoto3" src="${camp[i].image[2]}">
                    <img id="carPhoto4" src="${camp[i].image[3]}">
                </div>
                <div class="sum">
